...
- **Avatar identity pass:** Per-type silhouette (Ferro = compact hex, Terra = broad trapezoid, Flux = tall teardrop), face investment (eye system, blink, gaze-follow), readable builds (Power-spiky / Guard-armored / Speed-sleek), stat-change legibility at the moment of spend. Time-boxed to ~20 focused hours per audit §5; if procedural doesn't sing, fall back to AI-generated base art via Gemini Images (decision 2026-07-04 — replaces audit Q2 commission fallback).
